        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" style="margin-inline: 25%">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('services.store') }}" style="margin-inline: 20%">
                        @csrf
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="desc" name="desc" required autocomplete="desc"
                                ...
                                style="width:100%;height:100px">{{ old('desc') }}</textarea>
                        ...
                        <div class="flex-row">
                            <div class="mt-4">
                                ...
                                <x-text-input id="hours" class="block mt-1 w-full" type="text" name="hours"
                                    :value="old('hours')" required autocomplete="hours" min="0"
                                    onkeypress="return isNumberKey(event)" />
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="min" class="block mt-1 w-full" type="text" name="min"
                                    :value="old('min')" required autocomplete="min" min="0" max="59"
                                    onkeypress="return isNumberKey(event)" />
